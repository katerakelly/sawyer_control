...
RESET_SAFETY_BOX_LOWS = np.array([.2, -0.4, 0.1])
RESET_SAFETY_BOX_HIGHS = np.array([.8, 0.25, .4])
...
POSITION_SAFETY_BOX_LOWS = np.array([.2, -.2, .1])
POSITION_SAFETY_BOX_HIGHS = np.array([.6, .2, .37])
POSITION_SAFETY_BOX = Box(POSITION_SAFETY_BOX_LOWS, POSITION_SAFETY_BOX_HIGHS, dtype=np.float32)

POSITION_RESET_POS = np.array([0.45, 0.0,  0.23])
