...
class KinectImageService(object):
    image_width = 256
    image_height = 256
    def __init__(self, image_shape=(image_width, image_height, 3), topic="/kinect2/qhd/image_color"):
    ...
    def get_image(self, *args, width=image_width, height=image_height, **kwargs):
