...
class MslacPegInsertionEnv(SawyerEnvBase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        #self.reset_joint_positions = self.limits_lows_joint_pos + self.joint_pos_range/2.0 # modified by Tony
        self.reset_joint_positions = np.array([ 0.38670802, -0.76212013, -0.91199511,  1.92950678,  1.03574216, 0.83555567,  1.1440537 ])
    ...
    def compute_rewards(self, obs, action=None):
        ...
        print("in peg env: reward is:", reward)
