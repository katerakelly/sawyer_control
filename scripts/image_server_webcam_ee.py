...
class WebcamRecorder(object):
    def __init__(self):
        ...
        rospy.Subscriber("/ee_webcam/image_raw", Image_msg, self.store_latest_image)
...
def image_server():
    s = rospy.Service('images_webcam_ee', image, get_image_from_webcam)
    rospy.spin()

if __name__ == "__main__":
    rospy.init_node('ee_webcam_image_server', anonymous=True)
